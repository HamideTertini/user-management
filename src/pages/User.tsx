...
import { Layout, Input, Button, Space, Row, Col, Modal, Select, Spin, Typography, message } from "antd";
...
const Users = () => {
  ...
  const handleSortChange = (value: string) => {
    if (value) {
      ...
      const newSortOrder = sortBy === currentSortBy && sortOrder === 'ascend' ? 'descend' : 'ascend';
      ...
      <Content style={{ padding: '32px 24px' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <Text type="secondary">Manage and organize your users efficiently</Text>
          </div>
